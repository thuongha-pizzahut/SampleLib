...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/thuongha-pizzahut/SampleLib.git'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'XuanThuong' => 'thuong.ha@pizzahut.io' }
  s.source           = { :git => 'https://github.com/thuongha-pizzahut/SampleLib.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'PHDVMapLibrary/Classes/**/*'
